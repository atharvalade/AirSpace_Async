...
export interface AirSpaceNFTInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "NFTMinted(address,uint256,string)": EventFragment;
...
export interface AirSpaceNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AirSpaceNFTInterface;
